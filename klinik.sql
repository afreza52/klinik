...
CREATE TABLE `berobat` (
  ...
  `penatalaksanaan` enum('Rawat Jalan','Rawat Inap','Rujuk','Lannya') NOT NULL
...
(2, 1, 1, '2023-07-17', 'flu dan batuk', ' flu biasa', 'Rawat Jalan'),
(3, 2, 3, '2023-07-07', 'sakit tenggorokan', 'radang', 'Rawat Jalan');
...
(1, 'Dr.Robby Nurharis, Sp.A'),
(3, 'Dr. PRIYANTI KISWORINI, M. Kes, Sp.A');
...
(2, 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 'Admin jaya');
