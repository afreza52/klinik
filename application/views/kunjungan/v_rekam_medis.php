                        ...
                        <form action="<?= base_url('kunjungan/insert_rm'); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="keluhan"
                                    required><?= $d['keluhan_pasien']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Diagnosa</label>
                                <textarea type="text" class="form-control" name="diagnosa"
                                    required><?= $d['hasil_diagnosa']; ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <tbody>
                                ...
                                foreach ($resep as $r) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('kunjungan/hapus_resep/') . $r['id_resep'] . '/' . $r['id_berobat']; ?>"
                                                class="text-center text-danger">X</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
